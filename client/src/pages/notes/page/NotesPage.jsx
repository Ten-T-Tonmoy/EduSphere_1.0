...
const NotesPage = () => {
  ...
  return (
    <div className="min-min-h-svh bg-[#f8fafc] pb-12">
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="flex flex-wrap gap-2 bg-gray-200/60 p-1.5 rounded-2xl mb-8 w-fit shadow-inner border border-gray-200/80 backdrop-blur-sm">
          <button
            onClick={() => setActiveTab("courseMaterial")}
            className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 ${activeTab === "courseMaterial" ? "bg-white text-indigo-700 shadow-md" : "text-gray-600 hover:text-gray-900 hover:bg-gray-300/50"}`}
          >
            <BookOpen className="w-4 h-4" /> Course Material
          </button>
          <button
            onClick={() => setActiveTab("sharedNotes")}
            className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 ${activeTab === "sharedNotes" ? "bg-white text-indigo-700 shadow-md" : "text-gray-600 hover:text-gray-900 hover:bg-gray-300/50"}`}
          >
            <Users className="w-4 h-4" /> Shared Notes
          </button>
          <button
            onClick={() => setActiveTab("classMaterials")}
            className={`flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 ${activeTab === "classMaterials" ? "bg-white text-indigo-700 shadow-md" : "text-gray-600 hover:text-gray-900 hover:bg-gray-300/50"}`}
          >
        ...
        <div className="transition-all duration-500 ease-in-out">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 bg-indigo-50/50 p-4 rounded-2xl border border-indigo-100">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        ...
                        {!isOwner && (
                          <span className="ml-3 inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-xs font-bold tracking-wider uppercase">
                            Shared
                          </span>
                        )}
                      </h3>
                    ...
                    {isOwner && (
                      <button
                        ...
                        className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-blue-700 transition-all shadow-md disabled:opacity-50 flex items-center space-x-2 active:scale-95"
                      >
          ...
          {activeTab === "classMaterials" && <ImportantMaterialsTab />}
        </div>
      </main>
