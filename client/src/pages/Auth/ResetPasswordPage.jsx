  ...
  return (
    <div className="min-min-h-svh bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      >
        <Link
          to="/login"
          className="inline-flex items-center gap-1 text-xs font-bold text-slate-400 hover:text-indigo-600 mb-8 transition-colors"
        >
        ...
        {!sent ? (
          <form onSubmit={handleReset} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-indigo-600 text-white font-bold rounded-2xl shadow-lg shadow-indigo-100 flex items-center justify-center gap-2 hover:bg-indigo-700 active:scale-95 transition-all"
            >
          ...
          <motion.div
            ...
            className="text-center py-6 bg-emerald-50 rounded-[2rem] border border-emerald-100"
          >
            <p className="text-emerald-700 font-bold px-6">
