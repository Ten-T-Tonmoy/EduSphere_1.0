...
const SetNewPasswordPage = () => {
  ...
  return (
    <div className="min-min-h-svh bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        {!success ? (
          ...
          <div className="py-6">
            ...
            <p className="text-slate-500 font-medium">
              Your credentials have been synced. Redirecting to login...
            </p>
          </div>
        )}
      </motion.div>
